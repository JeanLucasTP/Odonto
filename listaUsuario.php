      ...
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li><a class="" href="IndexListaPaciente.html"> Lista de Pacientes</a></li>
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              ...
              <li><a class="" href="cadastroProfissional.html"> Cadastrar Usuários</a></li>
            </ul>
          </li>
          <li class="sub-menu">
            <a href="javascript:;" class="">
                      ...
                      <table class="table table-striped table-advance table-hover">
                        <tbody>
                          ...
                          <?php
                            ...
                            $query = mysqli_query ($conexao, "SELECT nome, tipoUsuario, data_nasc, cpf, telefone FROM usuario");
                                                       

                            $registros_usuarios = mysqli_num_rows($query);
